...
def main() -> None:
    try:
        ...
        # Asks if user wants to send email of the chatlog
        send_email_choice = input("Ønsker du å få tilsend chatloggen på e-post? (y/n): ").lower()
        if send_email_choice == 'y':
            user_email = input("Vennligst oppgi din e-postadresse: ")
            sendEmail(user_email, chatlog)
